...
Lists are fundamental for organizing information. HTML provides several ways to group related items into lists.

## What's in this module?

1.  **Unordered Lists**: Creating bulleted lists with `<ul>`.
